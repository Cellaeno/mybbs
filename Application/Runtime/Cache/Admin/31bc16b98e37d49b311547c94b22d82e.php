                ...
                <div class="result-content">
                    ...
                    <?php foreach ($replys as $reply): ?>
                        <tr>
                            ...
                            <td><?php echo ($reply['pid']); ?></td>
                            <td><?php echo ($reply['rcontent']); ?></td>
                            <td><?php echo ($user[$reply['uid']]); ?></td>
                            <td><?= date('Y-m-d H:i:s',$reply['created_at']) ?></td>
                            <td>
                                <a class="link-update" href="/index.php?m=admin&c=reply&a=edit&rid=<?php echo ($reply['rid']); ?>">修改</a>
                                <a class="link-del" href="/index.php?m=admin&c=reply&a=del&rid=<?php echo ($reply['rid']); ?>">删除</a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                    </table>
