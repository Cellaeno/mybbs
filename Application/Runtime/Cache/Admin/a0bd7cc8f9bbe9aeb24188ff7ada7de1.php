    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/index.php?m=admin&c=cate&a=update&cid=<?php echo ($cates['cid']); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php foreach($parts as $part_all): ?>
                                        <option value="<?php echo ($part_all['pid']); ?>" <?php if($part_all['pid'] == $cates['pid']){echo 'selected';} ?>><?php echo ($part_all['pname']); ?></option>
                                    <?php endforeach; ?>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select name="uid" id="catid" class="required">
                                        <option value="">请选择</option>
                                    <?php foreach($users as $user_all): ?>
                                        <option value="<?php echo ($user_all['uid']); ?>" <?php if($part_all['uid'] == $cates['uid']){echo 'selected';} ?> ><?php echo ($user_all['uname']); ?></option>
                                    <?php endforeach; ?>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="cname" size="50" value="<?php echo ($cates['cname']); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
