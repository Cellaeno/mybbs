                    ...
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="uname" name="uname" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>密码：</th>
                                <td>
                                    <input class="common-text required" name="upwd" size="50" value="" type="password">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>确认密码：</th>
                                <td>
                                    <input class="common-text required" name="repwd" size="50" value="" type="password">
                                </td>
                            </tr>
                            <tr>
                                <th>性别：</th>
                                <td>
                                    ...
                                    <input class="common-text" name="sex" size="50" value="s" type="radio">保密
                                </td>
                            </tr>
                            <tr>
