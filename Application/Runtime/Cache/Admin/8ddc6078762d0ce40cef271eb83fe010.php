...
<div class="topbar-wrap white">
 ...
 $uid = $_GET['uid']; ?>
            <ul class="top-info-list clearfix">
                <li><a href="#">管理员</a></li>
                <li><a href="./index.php?m=admin&c=user&a=pwd&uid=<?= $uid ?>">修改密码</a></li>
                <li><a href="#">退出</a></li>
            </ul>
        </div>
    </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                             <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="pid" size="50" value="<?php echo ($part['pid']); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
