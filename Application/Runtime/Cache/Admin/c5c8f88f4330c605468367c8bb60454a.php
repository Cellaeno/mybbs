                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="uname" name="uid" size="50" value="<?= $user['uid'] ?>" type="text" >
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>姓名：</th>
                                <td>
                                    <input class="common-text required" id="uname" name="uname" size="50" value="<?= $user['uname'] ?>" type="text" >
                                </td>
                            </tr>
                            <tr>
                                <th>性别：</th>
                                <td>
                                    <input class="common-text" name="sex" size="50" value="w" type="radio" <?php if($user['sex'] == 'w') {echo "checked";} ?>  value="1"> 女
                                    <input class="common-text" name="sex" size="50" value="m" type="radio" <?php if($user['sex'] == 'm') {echo "checked";} ?>  value="1"> 男
                                    <input class="common-text" name="sex" size="50" value="s" type="radio" <?php if($user['sex'] == 's') {echo "checked";} ?>  value="1"> 保密
                                </td>
                            </tr>
                            <tr>
