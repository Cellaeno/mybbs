    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/index.php?m=admin&c=cate&a=index" method="post">
                    <table class="search-tab">
                        <tr>
                            ...
                            <td>
                                ...
                                <?php foreach($part_all as $p): ?>
                                    <option value="<?php echo ($p['pid']); ?>"><?php echo ($p['pname']); ?></option>
                                <?php endforeach; ?>
                                </select>
                            </td>
                            <th width="70">板块名称:</th>
                            <td><input class="common-text" name="cname" value="" id="" type="text"></td>
                ...
                <div class="result-content">
                    ...
                    <?php foreach($cates as $cate): ?>
                        <tr>
                            ...
                            <td>
                                <a class="link-update" href="/index.php?m=admin&c=cate&a=edit&cid=<?php echo ($cate['cid']); ?>&uid=<?php echo ($cate['uid']); ?>&pid=<?php echo ($cate['pid']); ?>">修改</a>
                                <a class="link-del" href="/index.php?m=admin&c=cate&a=del&cid=<?php echo ($cate['cid']); ?>">删除</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </table>
                    <div class="list-page"><?php echo ($html_page); ?></div>
                </div>
            </form>
        </div>
    </div>
