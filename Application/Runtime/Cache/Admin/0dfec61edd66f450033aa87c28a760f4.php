            ...
            <form action="/index.php?m=admin&c=login&a=dologin" method="post">
                <ul class="admin_items">
                    <li>
                        ...
                        <input type="text" name="uname" value="" id="user" autocomplete="off" size="40" autofocus class="admin_input_style" />
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="text" name="code" autocomplete="off" value="" id="pwd" size="18" class="admin_input_style" />
                        <img style="vertical-align:middle;" src="/index.php?m=admin&c=login&a=code" alt="" onclick="this.src='/index.php?m=admin&c=login&a=code&x='+Math.random()">
                    </li>
                    <li>
