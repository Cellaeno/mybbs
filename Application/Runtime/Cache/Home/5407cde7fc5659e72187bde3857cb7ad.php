            ...
            <tr> 
             <td class="pls ptm pbm"> 
              <div class="hm"> 
               ...
               <span class="xi1"><?php echo ($posts['view_cnt']); ?></span>
               <span class="pipe">|</span>
               <span class="xg1">回复:</span> 
               <span class="xi1"><?php echo ($posts['rep_cnt']); ?></span> 
              </div> </td> 
             <td class="plc ptm pbn vwthd"> <h1 class="ts"> <a href="forum.php?mod=viewthread&amp;tid=6" id="thread_subject"><?php echo ($posts['title']); ?></a> </h1> <span class="xg1"> <a href="forum.php?mod=viewthread&amp;tid=6&amp;fromuid=1" onclick="return copyThreadUrl(this)" title="您的朋友访问此链接后，您将获得相应的积分奖励">[复制链接]</a> </span> </td> 
            </tr> 
           </tbody>
          </table> 
            ...
            <tbody>
             <tr> 
              <td class="pls" rowspan="2"> <a name="lastpost"></a> 
               <div class="pi"> 
                <div class="authi"> 
                 <a href="home.php?mod=space&amp;uid=1" target="_blank" class="xw1"><?php echo ($user[$posts['uid']]['uname']); ?></a> 
                </div> 
               </div> 
               <div> 
                <div class="avatar" onmouseover="showauthor(this, 'userinfo16')">
                 <a href="home.php?mod=space&amp;uid=1" target="_blank"><img src="/<?= getSm($user[$posts['uid']]['uface']) ?>" /></a>
                </div> 
                <div class="tns xg2"> 
                 <table cellspacing="0" cellpadding="0"> 
                  <tbody>
                ...
                <p><em><a href="home.php?mod=spacecp&amp;ac=usergroup&amp;gid=1" target="_blank"><?php if($user[$posts['uid']]['auth'] == 3){echo '用户';} ?></a></em></p> 
               </div> </td> 
              <td class="plc"> 
               <div class="pi"> 
                ...
                <div class="pcb"> 
                 <div class="t_fsz"> 
                  <table cellspacing="0" cellpadding="0">
                   <tbody>
                    <tr>
                     <td class="t_f" id="postmessage_16"> <?php echo ($posts['content']); ?></td>
                    </tr>
                   </tbody>
                  </table> 
                 </div> 
            ...
            <tbody>
             <tr> 
              <td class="pls" rowspan="2"> <a name="lastpost"></a> 
               <div class="pi"> 
                <div class="authi"> 
                 <a href="home.php?mod=space&amp;uid=1" target="_blank" class="xw1"><?php echo ($user[$reply['uid']]['uname']); ?></a> 
                </div> 
               </div> 
               <div> 
                <div class="avatar" onmouseover="showauthor(this, 'userinfo16')"> 
                 <a href="home.php?mod=space&amp;uid=1" target="_blank"> <img src="/<?= getSm($user[$reply['uid']]['uface']) ?>" /> </a> 
                </div> 
                <div class="tns xg2"> 
                 <table cellspacing="0" cellpadding="0"> 
                  <tbody>
              ...
              <td class="plc"> 
               <div class="pi"> 
                <strong> <a href="forum.php?mod=viewthread&amp;tid=6&amp;fromuid=1">第<?php echo ($n++); ?>楼</a> </strong> 
                <div class="pti"> 
                 <div class="pdbt"> 
                 </div> 
                 <div class="authi"> 
                ...
                <div class="pcb"> 
                 <div class="t_fsz"> 
                  <table cellspacing="0" cellpadding="0">
                   <tbody>
                    <tr>
                     <td class="t_f" id="postmessage_16"> <?php echo ($reply['rcontent']); ?></td>
                    </tr>
                   </tbody>
                  </table> 
                 </div> 
        ...
        <?php endforeach ?>
         ...
         <div id="f_pst" class="pl bm bmw"> 
          <form method="post" id="fastpostform" action="/index.php?m=home&c=reply&a=save">
            <input type="hidden" name="pid" value="<?php echo ($posts['pid']); ?>"> 
           <table cellspacing="0" cellpadding="0"> 
            <tbody>
             <tr> 
              <td class="pls"> 
              ...
              <td class="plc"> <span id="fastpostreturn"></span> 
               ...
               </div> <p class="ptm pnpost"> <button type="submit" id="fastpostsubmit" class="pn pnc vm" tabindex="5"><strong>发表回复</strong></button> </p> </td> 
             </tr> 
            </tbody>
           </table> 
          </form> 
