    ...
    <div class="content">   
            ...
            <div class="section">
                ...
                <div class="section_title">
                  ...
                  <span class="section_title_right">分区版主：<a href=""><?php echo ($users[$part['sub'][0]['uid']]); ?></a></span>
                </div>
                <!--分区标题部分end-->
                  ...
                  <table cellspacing="0" celpadding="0">
                    <tr>
                      <td width="33%">
                        ...
                        <dl>
                          <dd class="dd_title"><a href='/index.php?m=home&c=post&a=index&cid=<?php echo ($cate['cid']); ?>'><?= $cate['cname'] ?></a></dd>
                          <dd>
                            <em>主题：54</em>,
                            <em>帖子：244</em>
                          </dd>
