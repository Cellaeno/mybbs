  ...
  <div id="main">
    ...
    <!--内容部分start-->
        <div class="content">           
            ...
            <div class="send_btn">
                <div class="send">
                    <a href="/index.php?m=home&c=post&a=fatie&cid=<?php echo ($cid); ?>"><img src="./Public/Home/images/pn_post.png" /></a>
                </div>
            ...
            <div class="post_list" >
                ...
                <div class="post_content">
                    ...
                    <?php foreach ($posts as $post): ?>
                        <tr>
                            <td class="list_title"><a href="/index.php?m=home&c=reply&a=create&pid=<?php echo ($post['pid']); ?>"><?= $post['title'] ?></a></td>
